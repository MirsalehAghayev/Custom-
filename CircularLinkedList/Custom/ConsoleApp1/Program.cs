...
namespace LinkedList
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            myLinkedList.AddFirst("Sadiq");
            myLinkedList.AddFirst("Mirsaleh");
            myLinkedList.AddFirst("Qurban");
            myLinkedList.AddFirst("Samir");
            myLinkedList.AddFirst("Telman");
            myLinkedList.AddFirst("Saleh");

         
            myLinkedList.Remove("Nicat");
